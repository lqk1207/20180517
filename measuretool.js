...
ol.control.MeasureTool = function(opt_options) {
  ...
  html += '<li><input type="checkbox" value="no" checked="checked"></li>';
  html += '</ul>';
...
if (!contains(map.getLayers().getArray(),vector)){
map.addLayer(vector);
}
